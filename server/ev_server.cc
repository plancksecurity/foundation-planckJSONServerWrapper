...
const FunctionMap functions = {
		...
		FP( "cache_encrypt_message_with_full_input", new FuncPC<PEP_STATUS, In_Pep_Session, InOut<message*>, In<stringlist_t*>, Out<message*>, In<PEP_enc_format>, In<PEP_encrypt_flags_t>>( &pEp::MessageCache::cache_encrypt_message_with_full_input ) ),
		...
		FP( "cache_encrypt_message_for_self_with_full_input", new FuncPC<PEP_STATUS, In_Pep_Session,
			In<pEp_identity*>, In<message*>, In<stringlist_t*>, Out<message*>, In<PEP_enc_format>, In<PEP_encrypt_flags_t>>( &pEp::MessageCache::cache_encrypt_message_for_self_with_full_input) ),
